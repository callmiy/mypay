...
templates['newShiftMenuTemplate'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper;

  return "<div class=\"ui inverted menu shift-route-menu \">\n  <div class=\"ui container\">\n    <a id=\"go-back-from-shift-route\" class=\"item\" href=\""
    + container.escapeExpression(((helper = (helper = helpers.goBackUrl || (depth0 != null ? depth0.goBackUrl : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"goBackUrl","hash":{},"data":data}) : helper)))
