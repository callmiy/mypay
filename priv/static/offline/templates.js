...
templates['shiftDetailTemplate'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"shift-detail-row\">\n      <div class=\"date-times\">\n        <span>\n"
    ...
    + "          </span>\n        </div>\n\n        <span>\n                "
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.hoursGross : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
  ...
  return " "
    + container.escapeExpression(((helper = (helper = helpers.hoursGross || (depth0 != null ? depth0.hoursGross : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"hoursGross","hash":{},"data":data}) : helper)))
    + " hrs ";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;
